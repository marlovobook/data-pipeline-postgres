...
with DAG(
    ...
    start  >> task_download_from_s3 >> task_rename_file >> task_upload_to_s3 >> download_transformed_file end

    download_transformed_file >> create_table_in_data_warehouse >> load_data_into_data_warehouse